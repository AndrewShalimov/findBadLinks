...
public class SheetsQuickstart {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException, URISyntaxException {
        ...
        File jarFile = new File(SheetsQuickstart.class.getProtectionDomain().getCodeSource().getLocation().toURI());
        FileInputStream in = new FileInputStream(jarFile.getParentFile() + File.separator + CLIENT_SECRET_DIR);
